...
class Contact extends CI_Controller {
	...
	public function index()
	{
		if (isset($_POST['envoi'])) {
			...
			$message_txt = $_POST['sender'].$passage_ligne.$_POST['sujet'].$passage_ligne.$_POST['msg'];

			$message_html = "<html><head></head><body><b>".$_POST['sender']."</b>, ".$passage_ligne.$_POST['sujet'].",".$_POST['msg'].".</body></html>";
			...
			$header = "From: \"Site grison\"<".$_POST['sender'].">".$passage_ligne;

			$header.= "Reply-to: ".$_POST['sender'].$passage_ligne;
